...
class CLIPUNetModel(SRModel):
    ...
    def feed_data(self, data):
        ...
        #         out = self.jpeger(out, quality=jpeg_p)
            ...
            #     name = data['gt_path'][i].split('/')[-1]
            #     lq_img = tensor2img([self.lq[i]])
            #     gt_img = tensor2img([self.gt[i]])
            #     imwrite(lq_img, '/Users/x/documents/GitHub/clip-sr-fyp/BasicSR/sanity_check/'+'lq_'+name)
            #     imwrite(gt_img, '/Users/x/documents/GitHub/clip-sr-fyp/BasicSR/sanity_check/'+'gt_'+name)
